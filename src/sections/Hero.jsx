...
const Hero = () => {
  return (
    <div className="">
      <div className="flex w-full justify-between items-center  pt-20 pb-0 sm:py-20">
        <img src="/hero.svg" className="w-[50%]   h-auto" />
        <div className="flex-[1] w-[48%] flex flex-col items-center max-w-xs text-white text-center">
          ...
          <div className="hidden sm:flex flex-col ">
            ...
            <p>0xfb66321d7c674995dfcc2cb67a30bc978dc862ad</p>
          </div>
        </div>
      </div>
      <div className="flex sm:hidden w-full justify-center items-center flex-col pb-20 mt-5">
            ...
            <p className='text-center text-white'>0xfb66321d7c674995dfcc2cb67a30bc978dc862ad</p>
          </div>
